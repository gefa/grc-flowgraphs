...
import numpy as np
import sys;sys.path.insert(1, '/home/gnuradio/grc-flowgraphs');import ptfun as ptfun

from gnuradio import qtgui

class pam_test_002(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "pam_test_002")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("pam_test_002")
        ...
        self.settings = Qt.QSettings("GNU Radio", "pam_test_002")
        ...
        # Blocks
        ##################################################
        self._sps_range = Range(1, 50, 1, 5, 200)
        ...
        self.interp_fir_filter_xxx_0 = filter.interp_fir_filter_fff(1, ptfun.pampt(sps,'tri',[k,beta]))
    ...
    def set_sps(self, sps):
        self.sps = sps
        self.interp_fir_filter_xxx_0.set_taps(ptfun.pampt(self.sps,'tri',[self.k,self.beta]))
        self.qtgui_freq_sink_x_0.set_frequency_range(0, self.samp_rate*self.sps)
...
def main(top_block_cls=pam_test_002, options=None):
